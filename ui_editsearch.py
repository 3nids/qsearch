...
#
# Created: Wed Feb  8 16:37:40 2012
...
class Ui_editSearch(object):
    def setupUi(self, editSearch):
        ...
        self.gridLayout_2.addWidget(self.searchName, 1, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.closeButton, 6, 3, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.layerName, 0, 2, 1, 2)
        ...
        self.gridLayout_2.addWidget(self.itemsScroll, 3, 0, 1, 4)
        ...
        self.gridLayout_2.addWidget(self.selectButton, 2, 3, 1, 1)
